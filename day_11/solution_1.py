...
def is_all_seats_adjacent_are_empty(seats, row_nb, col_nb, nb_neighbours=8, row_to_explore=[-1, 0, 1],
    ...
    for new_row_pos in row_to_explore:
        for new_col_pos in col_to_explore:
            row = seats[row_nb + new_row_pos]
            col = row[col_nb + new_col_pos]
...
def is_four_or_more_seats_adjacent_are_occupied(seats, row_nb, col_nb, row_to_explore=[-1, 0, 1],
                                                col_to_explore=[-1, 0, 1]) -> bool:
    ...
    if nb_of_occupied_neighbours >= 4:
        return True
        ...
        for col_nb in range(0, len(seats[row_nb])):
            ...
            if 0 < row_nb < len(seats) - 1 and 0 < col_nb < len(row) - 1:
                if col == 'L':
                    ...
                    if is_four_or_more_seats_adjacent_are_occupied(seats, row_nb, col_nb):
                ...
                if col == 'L':
                    ...
                    if is_four_or_more_seats_adjacent_are_occupied(seats, row_nb, col_nb, [0, 1]):
                        seats_to_modify[row_nb] = replace_char_in_string(seats_to_modify[row_nb], col_nb, 'L')
                ...
                if col == 'L':
                    ...
                    if is_four_or_more_seats_adjacent_are_occupied(seats, row_nb, col_nb, col_to_explore=[0, 1]):
                        seats_to_modify[row_nb] = replace_char_in_string(seats_to_modify[row_nb], col_nb, 'L')
                ...
                if row_nb == 0 and col_nb == 0:
                    if col == 'L':
                        ...
                        if is_four_or_more_seats_adjacent_are_occupied(seats, row_nb, col_nb, row_to_explore=[0, 1],
                                                                       col_to_explore=[0, 1]):
                            seats_to_modify[row_nb] = replace_char_in_string(seats_to_modify[row_nb], col_nb, 'L')
